...
class DenseNet(nn.Module):
    ...
    """
    def __init__(self, sample_size=256, sample_duration=32, growth_rate=32, block_config=(6, 12, 24, 16),
...
if __name__ == '__main__':
    net = DenseNet(sample_duration= 32,
              sample_size=256,
              num_classes=2)
    net.cuda()    
    video = torch.randn(1, 1, 32, 256, 256).cuda() # (batch, channels, frames, height, width)

    # preds = v(video) # (x, 2)
    # print('preds', preds.shape)
    flops, params = profile(net, (video,))

...
from model_s3d_tra import Model
...
def init_parse():
    ...
    parser.add_argument('--output', type=str, default='s3d_att_tra_32', help='')
    parser.add_argument('--batch_size', type=int, default=8, help='number of batches for train')# 128
    ...
    parser.add_argument('--benchmark', type=str, default='cv',
                        choices=['cs', 'cv'])
    parser.add_argument('--feature_path', type=str, default='/home/user/data', help='')
    parser.add_argument('--modality', type=str, default='tra', choices=['rgb', 'tra'], help='')    
